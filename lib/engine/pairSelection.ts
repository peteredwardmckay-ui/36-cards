...
const SUBJECT_PAIR_MEANING_OVERRIDES: Partial<Record<SubjectId, Record<string, string>>> = {
  ...
  legal_admin: {
    ...
    "29-31": "your side of the matter becoming clearer and more usable once the process is visible enough to consider",
  ...
  money: {
    ...
    "2-29": "a small financial opening sitting close to your own choices, so even modest relief matters if it is used while it is available",
  ...
  personal_growth: {
    ...
    "22-29": "the road changes once you make a real choice about who you are willing to be",
  ...
  health: {
    "10-29": "a necessary cut, cleaner boundary, or firmer decision landing directly on your wellbeing and what you keep asking of yourself",
